...
const Nav = () => {
  ...
  return (
    <nav className="h-screen p-6 bg-neutral-500 text-white shadow-xl flex flex-col items-start  border border-gradient-to-r from-gray-700 to-gray-900">
          ...
          users
            ...
            .map((user, index) => (
              <button
                ...
                className="w-full p-4 bg-neutral-300 text-white rounded-lg flex items-center justify-between transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg text-lg"
              >
                <UserCard user={user} />
              </button>
            ))
