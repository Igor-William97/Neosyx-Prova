...
export default function Page() {
  ...
  return (
    selectedUser && (
      <main
        className="flex flex-col justify-between bg-neutral-500 min-h-screen h-full w-full flex-1 p-4"
      >
        <div className="flex flex-col w-full space-y-4 overflow-y-scroll max-h-[85vh] p-2">
            ...
            return (
              ...
              >
                <div
                  ...
                  } rounded-lg max-w-xs p-3 shadow-lg hover:shadow-2xl transition-shadow duration-300`}
                >
                  {showName && (
        ...
        <div className="mt-4 flex items-center space-x-2">
          <input
            className="w-full p-3 bg-gray-800 text-white rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder-gray-400"
            type="text"
